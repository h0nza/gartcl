...
#TODO: rejsek, rosomak
 CATEGORY1 = $(firstword $(CATEGORIES))
 MASTER_SITES  =
 MASTER_SITES += http://rosomak.ov.sasprg.cz/src/garchive/$(DISTNAME)/
 MASTER_SITES += http://rosomak.ov.sasprg.cz/src/$(CATEGORY1)/
